                ...
                @switch($client->status)
                    @case(1)
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-sm btn-outline-secondary" title="Documents" data-toggle="tooltip" value="{{$client->id}}"><i class="fa  fa-folder-open"></i></button>
                            </td>
                    @break
                    @case(2)
                            <td class="hidden-xs">
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-sm btn-outline-secondary btn_add_contacts" data-toggle="tooltip" title="Contacts" value="{{$client->id}}"><i class="fa fa-users"></i></button>
                                <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="tooltip" title="Documents" value="{{$client->id}}"><i class="fa  fa-folder-open"></i></button>
                            </td>
                    @break
                @endswitch 
