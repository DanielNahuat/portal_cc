...
class MenuTable extends Seeder
{
    ...
    public function run()
    {
        ...
        $menus = [
            ...
            ['name'=> 'Operators','icon'=> 'fa fa-users','link'=>'/types','prioridad'=> '1','status'=> 1,],
            ...
            ['name'=> 'Settings','icon'=> 'fa fa-briefcase','link'=>'/settings','prioridad'=> '1','status'=> 1,],
            ['name'=> 'Schedule Daily','icon'=> 'fa fa-calendar-o','link'=>'/','prioridad'=> '1','status'=> 1,],
